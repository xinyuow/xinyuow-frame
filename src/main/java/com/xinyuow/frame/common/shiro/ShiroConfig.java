...
//        filterChainDefinitionMap.put("/api/v1/workFlow/receiveMessages", "anon");   // 工作流节点执行回调方法 可以匿名访问
...
//        filterChainDefinitionMap.put("/interface/hiveTbls/**", "anon");           // 放行静态页面
//        filterChainDefinitionMap.put("/interface/hiveTblsFields/**", "anon");     // 放行静态页面
//        filterChainDefinitionMap.put("/interface/businessObject/**", "anon");     // 放行静态页面
//        filterChainDefinitionMap.put("/interface/dimensions/**", "anon");         // 放行静态页面
//
//        filterChainDefinitionMap.put("/webSocket", "anon");             // 放行webSocket
//
